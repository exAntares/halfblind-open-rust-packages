...
fn generate_item_definition_service_impl(component_types: &HashSet<String>) -> String {
    ...
    code.push_str("// This code is autogenerated by build.rs\n");
    code.push_str("\n\n");
    code.push_str("#[derive(Default, Debug)]\n");
    code.push_str("pub struct ItemDefinitionLookupServiceImpl { }\n");
    code.push_str("\n\n");
    code.push_str("impl ItemDefinitionLookupServiceImpl {\n");
